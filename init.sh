...
pip install --no-cache-dir "pybind11>=2.12" "numpy<2" py-cord pyyaml requests yt-dlp asyncio aiohttp \
    musicbrainzngs beautifulsoup4 aiofiles ffmpeg-python ffmpeg PyNaCl fuzzywuzzy python-Levenshtein spotdl stt

# Ensure necessary directories exist
for dir in /app/{lyrics,music,config,models,sources,utils}; do
...
FILES=(
    ...
    "sources/bandcamp_mp3.py" "sources/apple_music_mp3.py"
)
